...
const Footer= () =>{
    return(
        ...
        <section id="Footer" className="w-full h-[240px]">
            <div className=" bg-[#f3f4f6] footerContainer  flex justify-around mb-[10px]">
          ...
          {/* Sub Footer */}
          <div className="w-full mx-auto h-[48px] bg-violet-700 p-[12px]">
                <p className="text-center font-bold text-white ">Copyright 2022 © UMMG | Powered by Quokka Studio</p>
            </div>  
        </section>
